...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  edgeSensitivity = 30,
  glowColor = "222 90 64",
  backgroundColor = "hsl(240 16% 7% / 0.7)",
  borderRadius = 16,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ["#4F8EF7", "#6C6EF5", "#34D399"],
  fillOpacity = 0.5,
}) => {
  ...
  useEffect(() => {
    ...
    animateValue({ ease: easeInCubic, duration: 1500, end: 50, onUpdate: v => setCursorAngle((angleEnd - angleStart) * (v / 100) + angleStart) })
    animateValue({ ease: easeOutCubic, delay: 1500, duration: 2250, start: 50, end: 100, onUpdate: v => setCursorAngle((angleEnd - angleStart) * (v / 100) + angleStart) })
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "rgba(0,0,0,0.12) 0 2px 4px, rgba(0,0,0,0.12) 0 4px 8px, rgba(0,0,0,0.12) 0 8px 24px",
      }}
    >
