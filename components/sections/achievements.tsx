...
const ACHIEVEMENTS: Achievement[] = [
  {
    ...
    description: "Full tuition waiver awarded for academic excellence",
    year: "2022",
    type: "Scholarship",
    icon: GraduationCap,
  },
  ...
  },
  {
    ...
    description: "Won the inter-college photography competition",
    year: "2022",
    type: "Competition",
    icon: Trophy,
    rank: "1st",
  },
  {
    ...
    description: "Placed as runner-up in the inter-college short film competition",
    year: "2022",
    type: "Competition",
    icon: Medal,
    rank: "2nd",
