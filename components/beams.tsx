...
/* =========================================================================
   Beams — adapted from reactbits.dev for the Shahriar Khan portfolio.
   - Persistent WebGL background that lives behind the full page.
   - Mounted once, never re-mounted between sections.
   ========================================================================= */
